...
public class AddEmergencySteps extends CommonMethods{
	...
	@When("user add Emergency contacts {string}, {string} to employee and {string}, {int} and {string} numbers")
	public void user_add_Emergency_contact_s_to_employee_and_and_numbers(String name, String relationship, String homeTelephone, int mobileNo, String workNo) {
		
		String mob=Integer.toString(mobileNo);
		...
		sendText(addEmerg.contactMobilePhone, mob);
